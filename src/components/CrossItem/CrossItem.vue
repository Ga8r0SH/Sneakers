      ...
      <div v-else class="flex justify-between flex-wrap bg-white pl-16 pr-16 rounded-b-lg">
        <div v-for="sneaker in sneakers" class="max-w-52 my-6 ml-8 mr-8 border p-10 rounded-2xl shadow-lg relative"  :key="sneaker.id">
          ...
          <div class="flex justify-between items-center ">
            ...
            <div class="pl-8">
              <button class="border px-2 py-2 rounded-lg hover:bg-green-400">
                <svg width="12" height="12" viewBox="0 0 12 12" id='svg1' fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10.6653 5.13122H7.20214V1.66821C7.20214 0.332846 5.13114 0.332846 5.13114 1.66821V5.13122H1.668C0.332935 5.13122 0.332935 7.20215 1.668 7.20215H5.13114V10.6652C5.13114 12.0005 7.20214 12.0005 7.20214 10.6652V7.20215H10.6653C12.0005 7.20215 12.0005 5.13122 10.6653 5.13122Z" fill="#a8a8a8" />
                </svg>
                <svg class="hidden" width="12" height="12" viewBox="0 0 12 12" id="svg2" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const {fetchSneakers,sneakers, isLoading} = useSneakers(); 

onMounted(() => {
    fetchSneakers();
})
// if (!sneakers.length && isLoading) {
//   fetchSneakers();
// }
